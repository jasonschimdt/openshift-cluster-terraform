...
output "master-private_route53_dns" {
  value = "${aws_route53_record.master-a-record.name}"
}
...
output "node1-private_route53_dns" {
  value = "${aws_route53_record.node1-a-record.name}"
}
...
output "node2-private_route53_dns" {
  value = "${aws_route53_record.node2-a-record.name}"
}
